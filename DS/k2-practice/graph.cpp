...
private:
    ...
    void dfs_help_rec(size_t start, std::vector<bool>& visited) const;
...
void Graph::dfs_help_rec(size_t curr, std::vector<bool>& visited) const
{
    visited[curr] = true;
    std::cout << curr << " ";
...
int main()
{
    ...
    std::cout << "\nshortest path from 0 to 5 is: " << g.BFS_shortest_path_vector(0, 5) << std::endl;
    std::cout << "\nshortest path from 5 to 6 is: " << g.BFS_shortest_path_vector(5, 6) << std::endl;
    std::cout << "\nshortest path from 1 to 4 is: " << g.BFS_shortest_path_vector(1, 4) << std::endl;

    std::cout << "\nshortest path from 3 to 3 is: " << g.BFS_shortest_path_vector(3, 3) << std::endl;
